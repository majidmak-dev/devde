...
export default function Chatbot() {
    ...
    const [messages, setMessages] = useState<{ role: 'user' | 'assistant', content: string }[]>([
        { role: 'assistant', content: "Welcome to DevDesigns. I am your Lead AI Architect. How can I assist you in engineering your digital sovereignty today?" }
    ]);
                    ...
                    >
                        ...
                        <div className="p-4 bg-primary flex items-center justify-between text-white">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-sm">Lead AI Architect</h3>
            ...
            <AnimatePresence>
                {isOpen && isMinimized && (
                    ...
                    >
                        ...
                        <span className="text-xs font-black uppercase tracking-widest">Lead AI Architect</span>
